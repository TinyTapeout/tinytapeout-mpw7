create_clock -period 5 -name virtual_clock
set_max_delay 1 -to [get_pins {scan_wrapper_*/data_in}]
set_max_delay 1 -to [get_pins {scan_wrapper_*/data_in}] -from [get_pins {scan_wrapper_*/clk_out}]
